...
function () {
  ...
  _createClass(Setting, [{
    ...
    value: function fullNameSubmitForm(event, form) {
      event.preventDefault();
      var crudHandler = this.crudHandler.prepareData(form);
      var formHelper = this.fullNameFormHelper;
      var sendButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#js-fullname-submit');
    ...
    value: function _getChildren() {
      ...
      setTimeout(function () {
        ...
        var ab = setInterval(function () {
          console.log(parseInt(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#players').children('li.uis-active').attr('data-index')), winner);

          if (parseInt(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#players').children('li.uis-active').attr('data-index')) == winner) {
